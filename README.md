...
| `targetValue` | string | Absolute target value as a string (external/object metrics). Example: `"50"` (50 MB/s of network throughput) |
        ...
        metrics: [
            {
                ...
                targetValue: "50",                       // absolute target value (e.g. 50 MB/s of network throughput)
