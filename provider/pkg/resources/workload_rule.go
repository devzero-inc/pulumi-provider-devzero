...
// can be built-in (CPU/Memory/Network*) or external (prometheus, kafka, ...)
...
func (h *HPARuleConfigArgs) Annotate(a infer.Annotator) {
	...
	a.Describe(&h.Metrics, "HPA metric triggers (CPU, Memory, Network*, or external such as prometheus/kafka). Replaces the removed targetUtilization/primaryMetric fields.")
